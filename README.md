-------Доработка рег задания по оповещению релиза--------
...
## 🔔 Автоматическое оповещение о новых версиях

### Описание функционала

Реализован механизм автоматического оповещения пользователей о выходе новой версии конфигурации.
